...
extensions = [
    ...
    Extension("py6502sim.graphics.textdisplay", ["src/py6502sim/graphics/textdisplay.pyx"], include_dirs=include_dirs),
    Extension("py6502sim.peripheral.apple1", ["src/py6502sim/peripheral/apple1.pyx"], include_dirs=include_dirs),
]
