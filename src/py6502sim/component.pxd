...
cdef class Component:
    ...
    cdef unsigned char execute(self, unsigned int address, unsigned char data, bint read_write_bar) except *:
        """
    ...
    # Abstract class
    cdef inline unsigned char _read(self, unsigned int address):
        """
    ...
    # Abstract class
    cdef inline unsigned char _write(self, unsigned int address, unsigned char data):
        """
        SHOULD NOT BE ACCESSED PUBLICLY
