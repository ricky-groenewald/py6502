...
cdef class MOS6502:
    ...
    cdef unsigned char _current_op_code
    cdef unsigned char _current_data
    cdef unsigned short _current_address
    cdef unsigned char _write_buffer
    cdef bint _write_buffer_flag
